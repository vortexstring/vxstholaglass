...
profilename = SH.cleanInput(formData.get("profilename").toString());
...
dataModel = (ConProfiles) session.get(ConProfiles.class, id);
} else {
dataModel = new ConProfiles();
}
/*************ASSIGNING THE MODEL VALUES******************/
if(action.equals("c") || action.equals("u")){
dataModel.setProfileName(profilename);
...
returngridata = getConProfilesdata(id);
...
private String getConProfilesdata(Integer id) {
DataLoader ME = new DataLoader();
StringBuilder myquery = new StringBuilder("FROM ConProfiles Where profileId=" + id);
mydata = ME.getData(myquery.toString());
if (!mydata.isEmpty()) {
i = 1;
for (Iterator iterator = mydata.iterator(); iterator.hasNext();) {
ConProfiles conprofiles = (ConProfiles) iterator.next();
gridata = i + ","+conprofiles.getProfileName();
i++;
}
}
return gridata;
...
Map profilenamerules = new HashMap< String, Object>();
profilenamerules.put("required", "false");
profilenamerules.put("minlength", "0");
profilenamerules.put("maxlength", "20");
profilenamerules.put("isemail", "false");
profilenamerules.put("isalphanumeric", "false");
profilenamerules.put("isnumeric", "false");
profilenamerules.put("isinteger", "false");
profilenamerules.put("lengthmessage", "Length should be between "+profilenamerules.get("minlength")+" and "+profilenamerules.get("maxlength")+" " );
rules.put("profilename",profilenamerules);
