...
public class CrmSalesorderCrud {
/**
* ***Compulsory fields*****
*/
...
Date DTwritedt, DTcreatedt,Dsalesorderdate;
...
Session session;
CrmSalesorder dataModel;
Transaction tx = null;

/********Model specific variables************/

String salesordercode,salesorderdate,ref,comment,customerid,quoteid ,totalprice,vatamount;
Integer Ncustomerid,Nquoteid ;
...
salesordercode = SH.cleanInput(formData.get("salesordercode").toString());
salesorderdate = SH.cleanInput(formData.get("salesorderdate").toString());
...
quoteid = SH.cleanInput(formData.get("quoteid").toString());
...
Nquoteid = Integer.valueOf(quoteid);

//DATE VALUES
Dsalesorderdate= DH.StrDatetoDate(salesorderdate);
...
dataModel = (CrmSalesorder) session.get(CrmSalesorder.class, id);
} else {
dataModel = new CrmSalesorder();
}
/*************ASSIGNING THE MODEL VALUES******************/
if(action.equals("c") || action.equals("u")){
dataModel.setSalesorderCode(salesordercode);
dataModel.setRef(ref);
dataModel.setComment(comment);
dataModel.setSalesorderDate(Dsalesorderdate);
...
returngridata = getCrmSalesorderdata(id);
...
private String getCrmSalesorderdata(Integer id) {
DataLoader ME = new DataLoader();
StringBuilder myquery = new StringBuilder("FROM CrmSalesorder Where salesorderId=" + id);
...
gridata = "";
//gridata = i + ","+crmsalesorder.getSalesorderCode() + "," + crmsalesorder.getTotalPrice() + "," + crmsalesorder.getVatAmount() + "," + crmsalesorder.getRef() + "," + crmsalesorder.getComment() + "," + crmsalesorder.getCrmCustomer().getCustomerId() + "," + crmsalesorder.getCrmQuote().getQuoteId() + "," + crmsalesorder.getAllStatus().getStatusId() + "," + crmsalesorder.getCrmPos().getPosId() + "," + crmsalesorder.getConUser().getUserId() + "," + crmsalesorder.getCrmSalesorder().getSalesorderId() + "," + crmsalesorder.getCrmQuote().getQuoteId() + "," + crmsalesorder.getCrmPos().getPosId();
...
Map salesordercoderules = new HashMap< String, Object>();
salesordercoderules.put("required", "false");
salesordercoderules.put("minlength", "0");
salesordercoderules.put("maxlength", "20");
salesordercoderules.put("isemail", "false");
salesordercoderules.put("isalphanumeric", "false");
salesordercoderules.put("isnumeric", "false");
salesordercoderules.put("isinteger", "false");
salesordercoderules.put("lengthmessage", "Length should be between "+salesordercoderules.get("minlength")+" and "+salesordercoderules.get("maxlength")+" " );
rules.put("salesordercode",salesordercoderules);

Map salesorderdaterules = new HashMap< String, Object>();
salesorderdaterules.put("required", "false");
salesorderdaterules.put("minlength", "0");
salesorderdaterules.put("maxlength", "20");
salesorderdaterules.put("isemail", "false");
salesorderdaterules.put("isalphanumeric", "false");
salesorderdaterules.put("isnumeric", "false");
salesorderdaterules.put("isinteger", "false");
salesorderdaterules.put("lengthmessage", "Length should be between "+salesorderdaterules.get("minlength")+" and "+salesorderdaterules.get("maxlength")+" " );
rules.put("salesorderdate",salesorderdaterules);
...
Map quoteidrules = new HashMap< String, Object>();
quoteidrules.put("required", "false");
quoteidrules.put("minlength", "0");
quoteidrules.put("maxlength", "20");
quoteidrules.put("isemail", "false");
quoteidrules.put("isalphanumeric", "false");
quoteidrules.put("isnumeric", "false");
quoteidrules.put("isinteger", "false");
quoteidrules.put("lengthmessage", "Length should be between "+quoteidrules.get("minlength")+" and "+quoteidrules.get("maxlength")+" " );
rules.put("quoteid",quoteidrules);
