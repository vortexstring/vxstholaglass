...
dhtmlx.VirtualRenderStack={
	_init:function(){
        ...
        //GICHOYA EDITED THIS TO HIDE THE SCROLL BAR WHEN THE DATAVIEW OBJECT ALREADY FITS
        this._dataobj.style.overflowY="auto";
       // this._dataobj.style.overflowY="hidden";
