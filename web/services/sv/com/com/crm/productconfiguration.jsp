...
<%!
String configuration_name,has_colour,is_purchased,is_production,is_sold,has_dimensions,has_production_template ;
...
ItemConfigurationCrud crudItemConfiguration = new ItemConfigurationCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudItemConfiguration.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudItemConfiguration.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudItemConfiguration.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
