<%-- 
    ...
    Created on : Jan 30, 2016, 1:06:43 PM
    Author     : TBL
--%>
...
<%!
String item_id,uom_id,unit_price,supplier_id,currency_id,vat_id,effective_from,effective_to,min_qty,max_qty ;
...
ItemPurchaseCrud crudItemPurchase = new ItemPurchaseCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudItemPurchase.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudItemPurchase.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudItemPurchase.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
