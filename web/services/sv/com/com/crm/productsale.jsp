...
<%!
String item_id,uom_id,unit_price,currency_id,vat_id,effective_from,effective_to,min_qty,max_qty ;
...
ItemSaleCrud crudItemSale = new ItemSaleCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudItemSale.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudItemSale.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudItemSale.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
