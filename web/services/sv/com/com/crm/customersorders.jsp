<%-- 
    ...
    Created on : Jan 23, 2016, 6:33:35 PM
...
<%!
String salesorder_code,salesorder_date,total_price,vat_amount,ref,customer_id,quote_id,comment ;
...
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudCrmSalesorder.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudCrmSalesorder.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudCrmSalesorder.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
