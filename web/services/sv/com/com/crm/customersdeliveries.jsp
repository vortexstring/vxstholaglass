<%-- 
    ...
    Created on : Jan 28, 2016, 9:11:26 AM
...
<%!
String delivery_code,delivery_date,customer_id,amount,ref,salesorder_id,comment,approveby,approvedate ;
...
CrmDeliveryCrud crudCrmDelivery = new CrmDeliveryCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudCrmDelivery.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudCrmDelivery.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudCrmDelivery.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
