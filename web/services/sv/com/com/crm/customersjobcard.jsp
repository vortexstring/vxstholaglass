<%-- 
    ...
    Created on : Jan 28, 2016, 1:52:00 AM
...
<%!
String jobcard_code,jobcard_date,customer_id,salesorder_id,comment,reviewedby,reviewdt,approvedby,approvedt ;
...
MfcJobcardCrud crudMfcJobcard = new MfcJobcardCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudMfcJobcard.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudMfcJobcard.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudMfcJobcard.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
