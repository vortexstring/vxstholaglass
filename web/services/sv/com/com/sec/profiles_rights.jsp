<%-- 
    Document   : profiles_rights
    Created on : Feb 9, 2016, 11:12:01 AM
...
<%!
String profile_id,object_id,canview,canadd,canedit,candel,canauthorize,canapprove,canexport ;
...
ConObjectrightsCrud crudConObjectrights = new ConObjectrightsCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudConObjectrights.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudConObjectrights.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudConObjectrights.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
