...
<%!
String surname,other_name,profile_id,status ;
...
ConUserCrud crudConUser = new ConUserCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudConUser.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudConUser.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudConUser.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
