...
<%!
String username,password,login_key,user_id,profile_id,status_id,branch_id ;
...
ConAuthCrud crudConAuth = new ConAuthCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudConAuth.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudConAuth.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudConAuth.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
