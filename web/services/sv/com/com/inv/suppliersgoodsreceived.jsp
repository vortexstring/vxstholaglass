<%-- 
    ...
    Created on : Jan 27, 2016, 1:16:45 PM
...
<%!
String grn_id,recieved_date,ref,item_id,batch_no,purchaseqty,purchaseuom_qty,purchaseuom_id,purchaseunits,purchase_price,receiveduom_id,receivedqty,receivedunits,receivedprice,receiveduom_qty,store_id ;
...
InvGoodsreceivedLineCrud crudInvGoodsreceivedLine = new InvGoodsreceivedLineCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudInvGoodsreceivedLine.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudInvGoodsreceivedLine.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudInvGoodsreceivedLine.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
