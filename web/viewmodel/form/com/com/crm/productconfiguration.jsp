...
{type: "input", name:"configurationname",label:"Configuration Name", value:"<% out.print(configurationname); %>", required:"true" , validate:"ValidateLength"},
{type: "checkbox", name:"hascolour", label: "Has Colour" <% out.print(SH.formCheckbox(hasColour)); %>  },
{type: "checkbox", name:"ispurchased", label: "Is Purchased" <% out.print(SH.formCheckbox(isPurchased)); %>  },
{type: "checkbox", name:"isproduction", label: "Is Production" <% out.print(SH.formCheckbox(isProduction)); %>  },
{type: "checkbox", name:"issold", label: "Is Sold" <% out.print(SH.formCheckbox(isSold)); %>  },
{type: "checkbox", name:"hasdimensions", label: "Has Dimensions" <% out.print(SH.formCheckbox(hasDimensions)); %>  },
{type: "checkbox", name:"hasproductiontemplate", label: "Production Template" <% out.print(SH.formCheckbox(hasProductionTemplate)); %> },
