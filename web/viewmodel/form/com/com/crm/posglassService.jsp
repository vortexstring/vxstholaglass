...
{type: "combo", name:"dimensionuomid",label: "Dimensionuomid", filtering:true , required:"true", options:[]} ,
...
{type: "combo", name:"uomid",label: "Sale UOM", filtering:true , required:"true", options:[]} ,
...
{type: "combo", name:"itemsaleid",label: "Price ", filtering:true , required:"true", readonly:"true", options:[]} ,
