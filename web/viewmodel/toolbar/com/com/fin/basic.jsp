...
[ 
	...
	{ id: "new", type: "button", img: "new.gif", text: "New", title: "Opens a window to create a new record",},
        	{ id: "newdirect", type: "button", img: "new_dis.gif", text: "New Direct", title: "Opens a window to create a new Direct record",},
